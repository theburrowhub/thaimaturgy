...
export function AddImageAsset(arg1, arg2, arg3) {
...
export function ChooseImagesFolder() {
  return window['go']['wailsapp']['App']['ChooseImagesFolder']();
}

export function ChooseModuleFile() {
  return window['go']['wailsapp']['App']['ChooseModuleFile']();
}

export function ChoosePDFFile() {
  return window['go']['wailsapp']['App']['ChoosePDFFile']();
}
...
export function SaveParty(arg1) {
  return window['go']['wailsapp']['App']['SaveParty'](arg1);
}
...
export function StartTelegram() {
  return window['go']['wailsapp']['App']['StartTelegram']();
}

export function StopTelegram() {
  return window['go']['wailsapp']['App']['StopTelegram']();
}
...
export function ToggleMode() {
  return window['go']['wailsapp']['App']['ToggleMode']();
}
